...
class XGModelNN(XGModel):
    ...
    """
    def __init__(self, data_path, hidden_layers="64-32-16", dropout=0.3, random_state=37):
    ...
    def fit(self, verbose=2, n_epochs=100, batch_size=1024, **kwargs):
        ...
        x_train, x_val, y_train, y_val = train_test_split(x_train, self.y_train, train_size=0.8)
