...
import src.xg.apply_coords_adjustments as rink_adjust
...
def get_data(base_path):
    ...
    :return: DataFrame with info from 2007-2018
    """
    year = 2007
    ...
    while year < 2008:
        print(year)
        df = pd.read_csv(base_path / "data/pbp_csv/nhl_pbp_{a}{b}.csv".format(a=str(year), b=str(year+1)), sep=',')
        year += 1
